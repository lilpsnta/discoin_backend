      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        <a-row class="form-row" :gutter="24">
          <a-col :span="24" pull="2">
            <a-form-model-item
              ...
              <a-input placeholder="请输入标题" v-model="model.titile" style="width: 110%" :readOnly="disableSubmit"/>
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32 }">
          ...
          <a-col :span="12">
            <a-form-model-item
              ...
              :wrapperCol="wrapperCol"
              label="是否固顶">
              <a-switch checkedChildren="是" unCheckedChildren="否" v-model="model.top"/>
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32 }">
        ...
        <a-row class="form-row" :gutter="24">
          <a-col :span="24" pull="2">
            ...
            >
              <j-editor v-model="model.msgContent" style="margin-left: 4px;width: 110%"></j-editor>
            </a-form-model-item>
          </a-col>
        </a-row>
...
<script>
  ...
  export default {
    components: { ACol, JEditor, JDate, SelectUserListModal},
    ...
    data () {
      return {
        ...
        validatorRules:{
          ...
          top: [{ required: true, message: '请选择是否固顶!' }],
        },
        url: {
