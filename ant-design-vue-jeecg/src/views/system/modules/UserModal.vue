  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <!--租户分配-->
        <a-form-model-item label="租户分配" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="false">
          <j-multi-select-tag
            :disabled="disableSubmit"
        ...
        <a-form-model-item label="工作流引擎" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="false">
