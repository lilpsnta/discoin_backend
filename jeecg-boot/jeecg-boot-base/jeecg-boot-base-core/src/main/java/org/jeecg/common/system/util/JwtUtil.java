...
public class JwtUtil {
	 ...
	 * @return
	 */
	public static String signForAccount(String accountCode, String secret) {
		Date date = new Date(System.currentTimeMillis() + EXPIRE_TIME);
		Algorithm algorithm = Algorithm.HMAC256(secret);
		// 附带accountCode信息
		return JWT.create().withClaim("accountCode", accountCode).withExpiresAt(date).sign(algorithm);
